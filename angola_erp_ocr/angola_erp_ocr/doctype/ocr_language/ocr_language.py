...
class OCRLanguage(Document):
	def __init__(self, *args, **kwargs):
		...
		self.TESSDATA_LINK = self.TESSDATA_LINK = "https://github.com/tesseract-ocr/tessdata{}/blob/main/{}.traineddata?raw=true" #"https://github.com/tesseract-ocr/4.00/tessdata{}/blob/master/{}.traineddata?raw=true"
		if self.code:
	...
	def download_tesseract(self):
		...
		dest = os.getenv("TESSDATA_PREFIX", "/usr/share/tesseract-ocr/4.00/tessdata/") + \
