...
frappe.ui.form.on('OCR Read', {
    setup: function (frm) {
        frappe.call({
            method: "angola_erp_ocr.angola_erp_ocr.doctype.ocr_language.ocr_language.get_current_language",
            args: {
    ...
    import: function (frm) {
        if (typeof frm.doc.ocr_import != "undefined" && frm.doc.ocr_import !== '') {
            frappe.call({
                method: "angola_erp_ocr.angola_erp_ocr.doctype.ocr_import.ocr_import.generate_doctype",
                args: {
